...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark shadow-lg fixed-top">
      ...
      <div class="container-fluid banner">
        <div class="container text-center">
          ...
          <h3 class="display-1"> Lowongan Kerja PT MNC Group</h3>
          <a href="#layanan">
      ...
      <div class="countainer-fluid Layanan pt-5 pb-5 ">
        <div class="countainer text-center">
          ...
          <p>Pengertian dasar yang harus Anda ketahui!
    ...
    <div class="countainer-fluid pt-5 pb-5">
      <div class="countainer">
        ...
        <p class="text-center">Latar belakang PT MNC Group</p>
        <div class="clearfix pt-5 "><img src="https://www.bengkeldigital.com/wp-content/uploads/2013/04/MNC-Group-Logo-572x394.png" class="col-md-4 float-md-end-mb-3 crop-img" width="300" height="300"/>
        <p>PT MNC Asia Holding Tbk atau MNC Group, didirikan tahun 1989 sebagai perusahaan sekuritas dan menjadi perusahaan publik di Bursa Efek Indonesia tahun 1997. Tahun 2001, MNC Group melakukan ekspansi di bidang media dan merambah bisnis entertainment hospitality tahun 2007. Pada tahun 2022 MNC Group mengukuhkan pilar bisnis keempatnya yaitu sektor energi.

          Saat ini MNC Group merupakan grup investasi terkemuka Indonesia dengan 4 bisnis strategis: Media & Entertainment, Jasa Keuangan, Entertainment Hospitality dan Energi. MNC Group mengemban visi menjadi pilar penting pertumbuhan ekonomi nasional dan menjadi pelopor pengembangan teknologi.</p>
